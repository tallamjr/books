function [ D,k ] = QRalg_Givens( A,tol )
% Performs QR algorithm to deflate matrix A, 
%   QR factorization is performed with Givens Rotations
% Input arguments:
%   A, square matrix
%   tol, tolerance
% Output arguments:
...
[Q,R]=QR_Givens(U); % this function computes the QR factorization 
                    % of U using Givens rotations
U=R*Q; % compute R*Q
